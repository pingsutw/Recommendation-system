...
def preprocess(datadir, outdir):
    ...
    # 60% of the data are used for training, and 20% of the data are used
    # for validation, 20% of the data for testing
    with open(FLAGS.output_dir + 'tr.libsvm', 'w') as out_train:
        with open(FLAGS.output_dir + 'va.libsvm', 'w') as out_valid:
            with open(FLAGS.output_dir + 'te.libsvm', 'w') as out_test:
